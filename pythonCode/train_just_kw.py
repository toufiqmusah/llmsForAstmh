...
parser.add_argument('--w0', type=int, default=0)
...
parser.add_argument('--classes', type=int) #17 or 51

# Other arguments
parser.add_argument('--wandb_name', type=str, default='just_binary_kws_1')
...
print(args.layer_dims)
model = ASTMHClassifierKW(layer_dims=list(map(int,args.layer_dims[0].split())),
