...
class ASTMHClassifierConcatKeyW(LightningModule):
    """
    TO DO: 
    ...
    def __init__(self,
        ...
        super(ASTMHClassifierConcatKeyW, self).__init__()
        ...
        if usePreBuiltEmbeddings:
            ...
            # Input layer is embedding dimension plus encoded keywords dimension
            input_dim = llm.get_sentence_embedding_dimension() + num_kws
    ...
    def predict_step(self, batch, batch_idx):
        ...
        preds = self.forward(emb_kw) # Pass x through model
