# -*- coding: utf-8 -*-
"""
Created on Wed Apr 23 15:51:30 2025
...
class EmbeddingData(LightningDataModule):
    ...
    def __init__(self,
                 batch_size: int = 1024,
                 data_split: str = '1_41824',
                 LLM_name: str = 'all-mpnet-base-v2',
                 augmentations: list = ['', ''], 
                 num_aug_words: int = 1,
                 num_classes: int = 46,  # 46 in 2025, 51 in 2024
        ...
        self.test_data_df = \
            pd.read_excel(os.path.join(embed_dir, 
                                       "embedded_newAbstractsToReclassify_merged_18apr2025.xlsx"))
